  ...
  return (
    <div className="container">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <h2 className="notFound-h2">Página no encontrada.</h2>
        <p>La página que estás buscando no existe.
          Cómo llegaste aquí es un misterio. Pero puedes ir a la página principal.
        </p>
        <Link to="/" class="btn btn-outline-info btn-lg">INICIO</Link>
      </div>
    </div>
    </div>
  );
